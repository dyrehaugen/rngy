...
\hypertarget{lithium-ion}{%
\section{Lithium-ion}\label{lithium-ion}}

\textbf{Lithium-ion Batteries (LIBs)}
...
\hypertarget{long-duration-storage}{%
\chapter{Long-duration Storage}\label{long-duration-storage}}
